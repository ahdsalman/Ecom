        ...
        if (
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var options = {
                        key: 'rzp_test_kkh8FbBX7EFd5m', // Enter the Key ID generated from the Dashboard
                        ...
                        handler: function (responseb) {
                            ...
                            console.log(grand_total,"helo its saved")
                            $.ajax({
                                method: "POST",
                                url: "/placeorder/",
                                data: data,
                                success: function (responsec) {
                                    console.log(responsec.ordernumber,'--------ordernumber---')
                                    swal("Congratulations!", responsec.status, "success").then(
                                        (value) => {
                                            window.location.href =
                                                "/ordercomplete/"+ responsec.ordernumber + "/";
                                        }
                                    );
